...
const allTasks = [
  {id: 1, subject: 'Math', topic: 'Introducing Algebra', title: 'Operations in the correct order', description: 'default description', teacher_id: 1, grade_level: 8},
  {id: 2, subject: 'Math', topic: 'Introducing Algebra', title: 'The slope of a linear function', description: 'default description', teacher_id: 1, grade_level: 8},
  {id: 3, subject: 'Math', topic: 'Introducing Algebra', title: 'Identify properties', description: 'default description', teacher_id: 1, grade_level: 8},
  {id: 4, subject: 'Math', topic: 'Introducing Algebra', title: 'Equations with variables', description: 'default description', teacher_id: 1, grade_level: 8},
  {id: 5, subject: 'Math', topic: 'Introducing Algebra', title: 'Coordinate system and ordered pairs', description: 'default description', teacher_id: 1, grade_level: 8},
  {id: 6, subject: 'Math', topic: 'Introducing Algebra', title: 'Inequalities', description: 'default description', teacher_id: 1, grade_level: 8},

  {id: 7, subject: 'Math', topic: 'Graphing and functions', title: 'Linear equations in the coordinate plane II', description: 'default description', teacher_id: 1, grade_level: 8},
  {id: 8, subject: 'Math', topic: 'Graphing and functions', title: 'The slope of a linear function II', description: 'default description', teacher_id: 1, grade_level: 8},
  {id: 9, subject: 'Math', topic: 'Graphing and functions', title: 'Graphing linear inequalities II',description: 'default description', teacher_id: 1, grade_level: 8},
  {id: 10, subject: 'Math', topic: 'Graphing and functions', title: 'Linear equations in the coordinate plane III', description: 'default description', teacher_id: 1, grade_level: 8},
  {id: 11, subject: 'Math', topic: 'Graphing and functions', title: 'The slope of a linear function III', description: 'default description', teacher_id: 1, grade_level: 8},
  {id: 12, subject: 'Math', topic: 'Graphing and functions', title: 'Graphing linear inequalities III',description: 'default description', teacher_id: 1, grade_level: 8},
  {id: 13, subject: 'Math', topic: 'Graphing and functions', title: 'Solve systems of equations by graphing II',description: 'default description', teacher_id: 1, grade_level: 8},

  {id: 14, subject: 'Math', topic: 'Area and volumes', title: 'Measure areas',description: 'default description', teacher_id: 1, grade_level: 8},
  {id: 15, subject: 'Math', topic: 'Area and volumes', title: 'Solve systems of equations by graphing III',description: 'default description', teacher_id: 1, grade_level: 8},
  // Science
  {id: 16, subject: 'Science', topic: 'Astronomy', title: 'Astronomy #1', description: 'List all planets in order', teacher_id: 1, grade_level: 1},
  {id: 17, subject: 'Science', topic: 'Astronomy', title: 'Write a paper about Pluto', description: 'Should it be a planet in the Solar System or not?', teacher_id: 1, grade_level: 1},
  {id: 18, subject: 'Science', topic: 'Anatomy', title: 'Anatomy List #1', description: 'List all bones from the human body', teacher_id: 1, grade_level: 1},
  {id: 19, subject: 'Science', topic: 'Anatomy', title: 'Science Essay #1', description: 'Watch an episode of Grey\'s Anatomy and write an Essay about it', teacher_id: 1, grade_level: 1},
  // English
  {id: 20, subject: 'English', topic: 'Regular Verbs', title: 'Verb List #1', description: 'List 50 regular verbs and their present, past and past participle forms', teacher_id: 1, grade_level: 1},
  {id: 21, subject: 'English', topic: 'Irregular Verbs', title: 'Verb List #2', description: 'List 50 irregular verbs and their present, past and past participle forms', teacher_id: 1, grade_level: 1},
  {id: 22, subject: 'English', topic: 'Palindromes', title: 'Word List #1', description: 'List 10 palindromes in alphabetical order', teacher_id: 1, grade_level: 1},
  {id: 23, subject: 'English', topic: 'Poetry', title: 'All The Single Ladies', description: 'Read the lyrics for the poem "Put A Ring on It" written by the contemporary writer Beyonce Knowles', teacher_id: 1, grade_level: 1},
  // History
  {id: 24, subject: 'History', topic: 'Presidents', title: 'Presidents List #1', description: 'List all American presidents in alphabetical order', teacher_id: 1, grade_level: 1},
  {id: 25, subject: 'History', topic: 'American History', title: 'History Essay #1', description: 'Write an essay about the whole American history since day one', teacher_id: 1, grade_level: 1},
  {id: 26, subject: 'History', topic: 'American History', title: 'Reading #1', description: 'Read pages 234-432 from the textbook about American History', teacher_id: 1, grade_level: 1},
  {id: 27, subject: 'History', topic: 'WWII', title: 'Reading #2', description: 'Read pages 23-42 from the textbook', teacher_id: 1, grade_level: 1},
  {id: 28, subject: 'History', topic: 'WWI', title: 'Reading #3', description: 'Read pages 13-53 from the textbook', teacher_id: 1, grade_level: 1},
  {id: 29, subject: 'History', topic: 'MJ', title: 'Essay #1', description: 'Write an essay about life and death of Michael Jackson', teacher_id: 1, grade_level: 1},
]
...
const allQuizzes = [
  // Math
  {id: 1, subject: 'Math', title: 'Addition Quiz #1', teacher_id: 1, description: 'Basic sum problems', questions: [
   ...
   {id: 2, subject: 'Math', title: 'Subtraction Quiz #1', teacher_id: 1, description: 'Basic subtraction problems', questions: [
   ...
   {id: 3, subject: 'Math', title: 'Multiplication Quiz #1', description: 'Solve all the questions.', teacher_id: 1, questions: [
   ...
   {id: 4, subject: 'Math', title: 'Division Quiz #1', teacher_id: 1,  description: 'Somewhat hard division questions', questions: [
   ...
   {id: 5, subject: 'Math', title: 'Final Super Hard Quiz', teacher_id: 1,  description: 'Covering all content we study so far',questions: [
  ...
  // Science
  {id: 6, subject: 'Science', title: 'Science Quiz #1', teacher_id: 1,  description: 'Questions about the first 3 chapters of our textbook', questions: [
   ...
   {id: 7, subject: 'Science', title: 'Anatomy Quiz #1', teacher_id: 1, description: 'Read chapter 5 of our textbook before solving this quiz', questions: [
   ...
   {id: 8, subject: 'Science', title: 'Science Quiz #2', teacher_id: 1,  description: 'Random questions about life and science', questions: [
   ...
   // History
   {id: 9, subject: 'History', title: 'History Quiz #1', teacher_id: 1, description: 'American History questions about presidents', questions: [
   ...
   {id: 10, subject: 'History', title: 'History Quiz #2', teacher_id: 1, description: 'Read pages 35-57 before solving this quiz.', questions: [
   ...
   // English
   {id: 11, subject: 'English', title: 'Synonyms Quiz #1',  description: 'Review your notes from week 2 before solving this questions', teacher_id: 1, questions: [
   ...
   {id: 12, subject: 'English', title: 'English Quiz #1', description: 'Make sure you have your notes with you before solving this quiz. Also, remember to get the irregular verb list handed to you during class', teacher_id: 1, questions: [
   ...
   // Reading
   {id: 13, subject: 'Reading', title: 'Reading Quiz #1', description: 'Finish reading the book "The Sad Elephant That Had No Friends, But Himself"', teacher_id: 1, questions: [
